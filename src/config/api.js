...
export const API_ROUTES = {
  ...
  CHAT_SESSION_PAGE: (id) => 
    `${API_BASE_URL}/chat/session/${id}/page`,
  CONFIG: `${API_BASE_URL}/config`,
  ADD_AI_TO_SESSION: (sessionId) => 
    `${API_BASE_URL}/chat/session/${sessionId}/ai`,
  REMOVE_AI_FROM_SESSION: (sessionId, aiProfileId) => 
  ...
  GENERATE_AI_ORDER: (sessionId) => 
    `${API_BASE_URL}/chat/session/${sessionId}/generate-order`,
  CHAT_SESSION_AI_PROFILES: (sessionId) => `${API_BASE_URL}/chat/session/${sessionId}/ai-profiles`,
  EXPAND_TOPIC: (sessionId) => 
    `${API_BASE_URL}/system/session/${sessionId}/process`
}